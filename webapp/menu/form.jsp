        ...
        <div class="accordion-group">
          ...
          <div id="collapse-form" class="accordion-body collapse ${currentMenu == 'form' ? 'in' : ''}">
            <ul class="accordion-inner nav nav-list">
			  <li><a href="${tenantPrefix}/form/form-template-list.do"><i class="icon-user"></i>表单列表</a></li>
			  <li><a href="${tenantPrefix}/form/form-template-input.do"><i class="icon-user"></i>新建表单</a></li>
            </ul>
          </div>
        </div>
